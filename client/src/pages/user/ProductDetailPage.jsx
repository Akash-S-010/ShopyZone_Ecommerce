    ...
    <div className="container mx-auto p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="mt-4">
            <span className="text-2xl font-extrabold text-indigo-600">${Number(product.price).toFixed(2)}</span>
            {product.discountPrice && (
              <span className="ml-3 line-through text-gray-400">${Number(product.discountPrice).toFixed(2)}</span>
            )}
          </div>
